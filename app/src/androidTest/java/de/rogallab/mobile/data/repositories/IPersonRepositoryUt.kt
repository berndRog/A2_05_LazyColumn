...
import de.rogallab.mobile.data.initJsonFile
...
class IPersonRepositoryUt: KoinTest {
   ...
   fun setup() {
      ...
      _people = initJsonFile(_testFilePath!!)
      _dataStore.initialize() // true: isTest -> no seeding
   }
   ...
   fun findByIdUt_ok() {
      // arrange
      val id = "d22dd863-af44-4555-882a-d360bae0dcc0"
   ...
   fun insertUt_ok() {
      // arrange
      val person = Person(
         "Bernd", "Rogalla", "10000000-0000-0000-0000-000000000000")
//      val person = Person(
...
//         "10000000-0000-0000-0000-000000000000")
   ...
   fun updateUt_ok() {
      // arrange
      val id = "92905fcb-8de3-4ec6-bc4b-a2de92397155"
